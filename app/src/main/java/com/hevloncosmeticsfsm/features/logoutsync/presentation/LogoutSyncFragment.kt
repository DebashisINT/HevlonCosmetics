package com.hevloncosmeticsfsm.features.logoutsync.presentation
...
import com.hevloncosmeticsfsm.app.AppDatabase
import com.hevloncosmeticsfsm.app.NetworkConstant
...
import com.hevloncosmeticsfsm.app.utils.AppUtils
import com.hevloncosmeticsfsm.app.utils.Toaster
import com.hevloncosmeticsfsm.base.BaseResponse
import com.hevloncosmeticsfsm.base.presentation.BaseActivity
import com.hevloncosmeticsfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.hevloncosmeticsfsm.features.billing.api.AddBillingRepoProvider
import com.hevloncosmeticsfsm.features.billing.model.AddBillingInputParamsModel
...
import com.hevloncosmeticsfsm.features.dashboard.presentation.ReasonDialog
...
import com.hevloncosmeticsfsm.features.document.model.AddEditDocumentInputParams
import com.hevloncosmeticsfsm.features.document.model.DocumentAttachmentModel
...
import com.hevloncosmeticsfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.hevloncosmeticsfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.hevloncosmeticsfsm.features.orderhistory.model.*
...
import com.hevloncosmeticsfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.hevloncosmeticsfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.hevloncosmeticsfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.hevloncosmeticsfsm.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.hevloncosmeticsfsm.features.timesheet.model.AddTimeSheetInputModel
import com.hevloncosmeticsfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.hevloncosmeticsfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.hevloncosmeticsfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.hevloncosmeticsfsm.mappackage.SendBrod
import com.hevloncosmeticsfsm.widgets.AppCustomTextView
import com.hevloncosmeticsfsm.MonitorService
import com.hevloncosmeticsfsm.MySingleton
import com.hevloncosmeticsfsm.features.addshop.model.*
import com.hevloncosmeticsfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.hevloncosmeticsfsm.features.addshop.presentation.ShopExtraContactReq
import com.hevloncosmeticsfsm.features.addshop.presentation.multiContactRequestData
import com.hevloncosmeticsfsm.features.login.api.LoginRepositoryProvider
import com.hevloncosmeticsfsm.features.login.model.GetConcurrentUserResponse
import com.hevloncosmeticsfsm.features.login.model.WhatsappApiData
import com.hevloncosmeticsfsm.features.performance.model.Gps_status_list
import com.hevloncosmeticsfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.hevloncosmeticsfsm.features.returnsOrder.ReturnProductList
import com.hevloncosmeticsfsm.features.returnsOrder.ReturnRequest
import com.hevloncosmeticsfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhevloncosmeticsfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhevloncosmeticsfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xhevloncosmeticsfsmlogsample/log.zip").path);
